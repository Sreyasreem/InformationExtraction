...
def main():
   ...
   while 1: 
       ...
       print('\nDo you want movie information? (y/n)')
       reply = input()
       ...
       while 1:
            print('\nDo you want to enter a movie field into the log file? (y/n)')
            reply = input()
            if reply[0] == 'n' or reply[0] == 'N':
               break
            ...
            if Field_requested == 'Movie Name' : 
               ...
               if length == 0:
                  f.write('<'+ genre +'>'+'<'+movie+'>'+'<'+Field_requested+'>'+'<'+'N/A'+'>'+'\n')
